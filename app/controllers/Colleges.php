...
class Colleges
{
	...
	public function index()
	{
         ...
         if($slug)
        {
			...
			// Teachers Start
			$query = "select teachers.* FROM teachers JOIN institutions ON teachers.institution_id = institutions.id WHERE institutions.slug = '$slug' AND isDeptHead = 'No'";
			$data['teachers'] = $this->query($query);

			// Single head
			$query = "select teachers.* FROM teachers JOIN institutions ON teachers.institution_id = institutions.id WHERE institutions.slug = '$slug' AND isDeptHead = 'Yes'";
			$data['single_head'] = $this->query($query);
