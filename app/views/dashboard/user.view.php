              ...
              <form method="post" enctype="multipart/form-data">
                <div class="row g-3 my-3 mx-auto">
                  ...
                  <div class="col-md-3">
                    ...
                    <input value="<?= old_value('school_id') ?>" type="text" class="form-control" id="school_id"
                      name="school_id" placeholder="PPY-00002">
                    <div><small class="text-danger">
                        <?= $user->getError('school_id') ?>
                      </small></div>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-5">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="gender" id="gender2" value="Female"> Female
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <input name="birthday" value="<?= old_value('birthday') ?>" type="date" class="form-control"
                      id="birthday">
                    <div><small class="text-danger">
                    ...
                    <select id="role" class="form-select" aria-label="Default select example" name="role">
                      <?php if (!empty($institutions)): ?>
                        <?php foreach ($institutions as $institutionz): ?>
                          <option <?= old_select('category_id', $institutionz->id) ?> value="<?= $institutionz->id ?>">
                            <?= $institutionz->name . ' ' . 'Rep' ?></option>
                        <?php endforeach; ?>
                      <?php endif; ?>
                    </select>
                  </div>
    ...
    <div class="main-panel">
      <div class="content-wrapper">
                ...
                <?php if (!empty($row)): ?>
                  <form method="post" enctype="multipart/form-data">
                    <div class="row g-3 my-3 mx-auto">
                      ...
                      <div class="col-md-3">
                        <label for="userid" class="form-label">School ID</label>
                        <input value="<?= old_value('school_id', $row->school_id) ?>" type="text" class="form-control"
                          id="school_id" name="school_id" placeholder="PPY-00002">
                        <div><small class="text-danger">
                            <?= $user->getError('school_id') ?>
                          </small></div>
                      </div>
                      <div class="col-md-3">
                        <label for="username" class="form-label">User Name</label>
                        <input value="<?= old_value('username', $row->username) ?>" type="text" class="form-control"
                          id="username" name="username" placeholder="juaan">
                        <div><small class="text-danger">
                            <?= $user->getError('username') ?>
                          </small></div>
                      </div>
                      <div class="col-md-3">
                        <label for="fname" class="form-label">First Name</label>
                        <input value="<?= old_value('first_name', $row->first_name) ?>" type="text" class="form-control"
                          id="fname" name="first_name" placeholder="Juan">
                        <div><small class="text-danger">
                            <?= $user->getError('first_name') ?>
                          </small></div>
                      </div>
                      <div class="col-md-3">
                        <label for="lname" class="form-label">Last Name</label>
                        <input value="<?= old_value('last_name', $row->last_name) ?>" type="text" class="form-control"
                          id="lname" name="last_name" placeholder="DelaCruz">
                        <div><small class="text-danger">
                            <?= $user->getError('last_name') ?>
                          </small></div>
                      </div>
                            ...
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="gender" id="gender1" value="Male"
                                  <?= old_checked('gender', 'Male', $row->gender) ?>> Male </label>
                            </div>
                          </div>
                          <div class="col-sm-5">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="gender" id="gender2" value="Female"
                                  <?= old_checked('gender', 'Female', $row->gender) ?>> Female </label>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <label for="bday" class="form-label">Birthday</label>
                        <input value="<?= old_value('birthday', $row->birthday) ?>" type="date" class="form-control"
                      ...
                      <div class="col-md-4">
                        <label for="email" class="form-label">Email</label>
                        <input value="<?= old_value('email', $row->email) ?>" type="email" class="form-control" id="email"
                          name="email" placeholder="Juan@gmail.com">
                        <div><small class="text-danger">
                            <?= $user->getError('email') ?>
                          </small></div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <label for="contact" class="form-label">Contact Number</label>
                        <input value="<?= old_value('phone', $row->phone) ?>" type="number" class="form-control" id="contact"
                          name="phone" placeholder="09337849329">
                        <div><small class="text-danger">
                            <?= $user->getError('phone') ?>
                          </small></div>
                      </div>
                      <div class="col-md-4">
                        <label for="address" class="form-label">Address</label>
                        <input value="<?= old_value('address', $row->address) ?>" type="text"
                          class="form-control text-center" name="address" id="address"
                          placeholder="Purok Gulod, Brgy. Bago, General Tinio Nueva Ecija">
                        <div><small class="text-danger">
                            <?= $user->getError('address') ?>
                          </small></div>
                      </div>
                      <div class="col-md-4">
                        ...
                        <select id="role" class="form-select" aria-label="Default select example" name="role">
                          <?php if (!empty($institutions)): ?>
                            <?php foreach ($institutions as $institutionz): ?>
                              <option <?= old_select('role', $institutionz->id, $row->role) ?> value="<?= $institutionz->id ?>">
                                <?= $institutionz->name . ' ' . 'Rep' ?></option>
                            <?php endforeach; ?>
                          <?php endif; ?>
                        </select>
        ...
        <?php else: ?>
          ...
          <div class="mb-5"> <a href="<?= ROOT ?>dashboard/user" class="btn  btn-gradient-secondary float-end btn-lg me-2">
              BACK </a> </div>
        <?php endif; ?>
                  ...
                  <div class="card-body">
                    <div style="overflow-x:auto;">
                      <form method="post" class="text-center">
                        ...
                        <div class="form-control mt-3 w-50 mx-auto"><?= old_value('userid', $row->school_id) ?></div>
                        <div class="form-control mt-3 w-50 mx-auto"><?= old_value('firstname', $row->first_name) ?></div>
                        <div class="form-control mt-3 w-50 mx-auto"><?= old_value('userid', $orgname[0]->name) ?></div>
