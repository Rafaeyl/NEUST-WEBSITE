              ...
              <form method="post" enctype="multipart/form-data">
                <div class="row g-3 my-3 mx-auto">
                  <div class="col-md-8 mx-auto w-75">
                    ...
                    <input value="<?= old_value('question') ?>" type="text" class="form-control text-center" id="question" name="question"
                      placeholder="Enter FAQ's question" required>
                  </div>
                  <div class="col-md-8 mx-auto w-75">
                    <label for="answer" class="form-label">FAQ's Answer</label>
                    <textarea rows="7"name="answer" class="form-control text-center" id="summernote" type="content"  placeholder="Enter FAQ's Answer"><?=old_value('answer')?></textarea>
                  </div>
                  <div class="col-md-8 mx-auto w-75">
            ...
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data">
               <div class="row g-3 my-3 mx-auto">
                <div class="col-md-8 mx-auto w-75">
                    <label for="question" class="form-label">FAQ's Question</label>
                    <input value="<?= old_value('question',$row->question) ?>" type="text" class="form-control text-center" id="question" name="question"
                      placeholder="Enter FAQ's question" required>
                  </div>
                  <div class="col-md-8 mx-auto w-75">
                    <label for="answer" class="form-label">FAQ's Answer</label>
                    <textarea rows="7"name="answer" class="form-control text-center" id="summernote" type="content"  placeholder="Enter FAQ's Answer"><?=old_value('answer',$row->answer)?></textarea>
                  </div>
                  <div class="col-md-8 mx-auto w-75">
                    <label for="list_order" class="form-label">List Order</label>
