  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h1>College's Officials</h1>
      </div>
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2 class="mb-4 text-center">Add College's Official</h2>
                ...
                <div class="row g-3 my-3 mx-auto">
                  <div class="col-md-12 text-center mb-5">
                    ...
                    <label>
                      ...
                      <div><small class="text-danger"> <?= $collegeOfficials->getError('image') ?></small></div>
                    </label>
                  </div>
                  ...
                  <div class="col-md-6 text-center">
                    ...
                    <input value="<?= old_value('position') ?>" type="text" class="form-control text-center" id="position"
                      ...
                      <div><small class="text-danger"> <?= $collegeOfficials->getError('position') ?></small></div>
                  </div>
                  <div class="col-md-6 text-center">
                    ...
                    <input value="<?= old_value('list_order') ?>" type="number" class="form-control text-center" id="list_order"
                      ...
                      <div><small class="text-danger"> <?= $collegeOfficials->getError('list_order') ?></small></div>
                  </div>
                  <div class="col-md-6 text-center">
                  ...
                  <div class="col-6">
                      <a href="<?=ROOT?>dashboard/college_official" class="btn btn-gradient-secondary float-end btn-lg my-4">
                          BACK
                      </a>
                  </div>
    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2 class="mb-4 text-center">Update College's Official</h2>
              <?php if(!empty($row)):?>
                <form method="post" enctype="multipart/form-data">
                <div class="row g-3 my-3 mx-auto">
                  <div class="col-md-12 text-center mb-5">
              ...
              <?php else:?>
                ...
                <div class="mb-5"> <a href="<?=ROOT?>dashboard/college_official" class="btn  btn-gradient-secondary float-end btn-lg me-2">  BACK </a>  </div>
              <?php endif;?>
              <script>
                function display_image(file, e) {
                  let img = e.currentTarget.parentNode.querySelector("img");
            ...
            <div class="card-body">
              ...
              <?php
                ...
                <form method="post" class="text-center">
                  ...
                  <a href="<?= ROOT ?>dashboard/college_official" class="btn btn-secondary float-end btn-lg mt-3">
                    BACK
                  </a>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <h1>
              College's Officials &nbsp;
              <a href="<?= ROOT ?>dashboard/college_official/new" class="mb-4">
                               ...
                               <td><?= $num++ ?>
                                ...
                                <td>
                                  <button type="button" class="btn btn-inverse-info btn-icon">
                                    <a  href="<?=ROOT?>dashboard/college_official/edit/<?=$row->id?>">
                                      <i class="mdi mdi-account-edit"></i>
                                    </a>
                                  </button>
                                  <a href="<?= ROOT ?>dashboard/college_official/delete/<?= $row->id ?>">
