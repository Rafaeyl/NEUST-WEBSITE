  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h1>Colleges's About Us</h1>
      </div>
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2 class="mb-4 text-center">Add Colleges's About Us</h2>
                ...
                <div class="row g-3 my-3 mx-auto">
                  <div class="col-md-12 text-center mb-3">
                    ...
                    <label>
                      ...
                      <div><small class="text-danger"> <?= $collegeAbout->getError('image') ?></small></div>
                    </label>
                  </div>
                  <div class="col-md-6 text-center mb-3">
                    ...
                    <input value="<?= old_value('title') ?>" type="text" class="form-control text-center  mx-auto w-75" id="title" name="title"
                      ...
                      <div><small class="text-danger"> <?= $collegeAbout->getError('title') ?></small></div>
                  </div>
                  <div class="col-md-6 text-center mb-3">
                    ...
                    <div><small class="text-danger"> <?= $collegeAbout->getError('description') ?></small></div>
                  </div>
                  <div class="col-md-4 text-center">
                    ...
                    <input value="<?= old_value('students') ?>" type="number" class="form-control text-center  mx-auto w-75" id="students" name="students"
                      ...
                      <div><small class="text-danger"> <?= $collegeAbout->getError('students') ?></small></div>
                  </div>
                  <div class="col-md-4 text-center">
                    ...
                    <input value="<?= old_value('activities') ?>" type="number" class="form-control text-center  mx-auto w-75" id="activities" name="activities"
                      ...
                      <div><small class="text-danger"> <?= $collegeAbout->getError('activities') ?></small></div>
                  </div>
                  <div class="col-md-4 text-center">
                  ...
                  <div class="col-6">
                      <a href="<?=ROOT?>dashboard/college_about" class="btn btn-gradient-secondary float-end btn-lg my-4">
                          BACK
                      </a>
                  </div>
    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h2 class="mb-4 text-center">Update Colleges's  About Us</h2>
              <?php if(!empty($row)):?>
                <form method="post" enctype="multipart/form-data">
                <div class="row g-3 my-3 mx-auto">
                  <div class="col-md-12 text-center mb-3">
              ...
              <?php else:?>
                ...
                <div class="mb-5"> <a href="<?=ROOT?>dashboard/college_about" class="btn  btn-gradient-secondary float-end btn-lg me-2">  BACK </a>  </div>
              <?php endif;?>
              <script>
                function display_image(file, e) {
                  let img = e.currentTarget.parentNode.querySelector("img");
            ...
            <div class="card-body">
              ...
              <?php
                ...
                <form method="post" class="text-center">
                  ...
                  <a href="<?= ROOT ?>dashboard/college_about" class="btn btn-secondary float-end btn-lg mt-3">
                    BACK
                  </a>
                            ...
                            <tr>
                               <td><?= $num++ ?>
                                ...
                                <td>
                                  ...
                                  <a href="<?= ROOT ?>dashboard/college_about/delete/<?= $row->id ?>">
