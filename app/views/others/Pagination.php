...
class Pagination{ 
    ...
    var $fullTagOpen    = '<div class="pagination justify-content-center"> '; 
    var $fullTagClose   = '</div>'; 
    var $firstTagOpen   = ''; 
    var $firstTagClose  = '&nbsp;'; 
    var $lastTagOpen    = '&nbsp;'; 
    var $lastTagClose   = ''; 
    var $curTagOpen     = '&nbsp;<b class="page-link">'; 
    var $curTagClose    = '</b>'; 
    var $nextTagOpen    = '&nbsp;'; 
    var $nextTagClose   = '&nbsp;'; 
    var $prevTagOpen    = '&nbsp;'; 
    ...
    function getAJAXlink( $count, $text) { 
        ...
        return "<a href=\"javascript:void(0);\" " . $this->anchorClass . " 
                ". $linkClick ."class='page-link'>". $text .'</a>'; 
    } 
} 
?>