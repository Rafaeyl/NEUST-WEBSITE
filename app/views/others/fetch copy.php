...
$sql = "select news.*, news_categories.name from news join news_categories on news.category_id = news_categories.id WHERE name LIKE '%$search%' OR  title LIKE '%$search%' OR  description LIKE '%$search%' ORDER BY date desc";  
