<?= $this-> view('includes/header', $data); ?>
  ...
  <!-- SLIDER START -->
	<section class="home">
		<div class="slider">
			<?php if(!empty($slideShow)):?>
				...
				<?php endforeach; ?>
			<?php else : ?>
				<center><h1>NO Slide FOUND</h1></center>
			<?php endif;?>
		</div>
				...
				<div class="col-md-6 align-items-stretch d-flex">
					<div class="img img-video d-flex align-items-center" style="background-image: url(<?= ROOT?>/assets/images/image-school/school-1.jpg);">
						<div class="video justify-content-center">
								<a href="https://www.youtube.com/watch?v=lON_VoGHhUs" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
							...
							<?php foreach($news as $row):?>
								<div class="col-md-3 ftco-animate my-2">
									<div class="blog-entry" >
										...
										<div class="text bg-white p-4" style="height:500px;">
	...
	<section class="ftco-section ftco-counter img m-0 bg-dark "  id="section-counter" style="background-image: url(<?= ROOT?>/assets/images/image-school/school-1.jpg);" data-stellar-background-ratio="0.5">
		<div class="row justify-content-center mb-2 ">
			<div class="col-md-8 text-center heading-section ftco-animate">
				<h2 class=" text-white"><?= $gallery_name[0]->title ?? '' ?></h2>
	...
	<div class="row justify-content-center  my-5">
            <?php if(!empty($announcements)):?>
                ...
                <?php endforeach; ?>
            <?php else : ?>
                <center><h1 class="text-danger">NO ANNOUNCEMENTS FOUND</h1></center>
            <?php endif;?>
        </div>
