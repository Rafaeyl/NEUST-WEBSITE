...
class DB{ 
    ...
    public function getRows($conditions = array()){ 
        ...
        $sql .= " LEFT JOIN {$this->imgTbl} AS I ON (I.gallery_id = P.id AND I.id = (SELECT MAX(id) FROM gallery_images WHERE gallery_id=P.id)) "; 
            ...
            switch($conditions['return_type']){ 
                ...
                case 'single': 
                    ...
                    if(!empty($data['id'])){ 
                        ...
                        $sub_query = "SELECT * FROM {$this->imgTbl} WHERE gallery_id={$data['id']} ORDER BY id DESC"; 
