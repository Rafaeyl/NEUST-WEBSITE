				...
				<div class="row g-5">
					<div class="col-lg-4">
						<div class="row g-5">
							...
							<div class="col-12 mt-3"  data-aos="zoom-in" data-aos-duration="1200">
								<div class="bg-primary rounded d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
					...
					<div class="col-lg-4 "  data-aos="zoom-out-up" data-aos-duration="1300" style="min-height: 350px;">
						<div class="position-relative h-100">
							<img class="position-absolute w-100 h-100 rounded" data-aos-duration="0.1s" src="images/about.jpg" style="object-fit: cover;">
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row g-5">
    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(images/bg_5.jpg);" data-stellar-background-ratio="0.5" id="contact">
    	<div class="overlay"></div>
    	<div class="container">
            ...
            <div class="blog-entry">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="fa-solid fa-arrow-right "></span></a></p>
